...
# Create table and seed the database
Chef.create_table
Chef.seed
...
chefs.each do |chef|
  puts "ID: #{chef[0]}"
  puts "Name: #{chef[1]} #{chef[2]}"
  puts "Birthday: #{chef[3]}"
  puts "Email: #{chef[4]}"
  puts "Phone: #{chef[5]}"
  puts "Created At: #{chef[6]}"
  puts "Updated At: #{chef[7]}"
  puts "-" * 30  # separator for readability
end